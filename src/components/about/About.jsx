...
import "./about.css";
import AboutImg from "../../assets/fotoijazah.png";
import CV from "../../assets/CV_Putra_sawung_Jagad.pdf";
    ...
    <section className="about section" id="about">
      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          <Info />
          <p className="about__description">Perkenalkan nama saya Putra Sawung Jagad lahir di Surakarta pada tanggal 23 Januari,saya sangat menyukai bidang jurusan SMK saya yaitu teknologi dan pengembangan perangkat lunak,entah itu Web dev Android App maupun data science.</p>
          <a
            download=""
            href={CV}
            className="button 
